...
export const QRCodeModal: React.FC<QRCodeModalProps> = ({ qrcodeValue, closeFunc, isOpen }) => {
                ...
                <div className="min-h-screen px-4 text-center">
                    ...
                    >
                        <DialogPanel className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                            ...
                            <div className="mt-4">
                                {qrcodeValue ? (
                                    <div role="img" aria-label={`QR Code for ${qrcodeValue}`}>
                                        <QRCode value={qrcodeValue} size={192} />
                                    </div>
                                ) : (
                                    <p className="text-red-500">QR Code is unavailable</p>
                                )}
                            </div>
